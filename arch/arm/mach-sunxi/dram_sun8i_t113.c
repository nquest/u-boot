...
unsigned int init_DRAM(int type, dram_para_t *para) // s0
{
	int rc, mem_size;
...
// Allwinner dram paramteres from boot0 code
static struct dram_para_t dram_para = {
    0x00000318, // DRAM clock 792
    0x00000003, // DDR 3
    0x007b7bfb, // dram ZQ (not userd)
    0x00000000, // DRAM ODT (0)
    0x000010d2, // dram_para_1
    0x00000000, // dram_para_2
    0x00001c70, // mr0
    0x00000042, // mr1
    0x00000018, // mr2
    0x00000000, // mr3
