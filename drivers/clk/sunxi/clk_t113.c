...
static struct ccu_clk_gate t113_gates[] = {
	...
	[CLK_EMAC_25M]		= GATE(0x970, BIT(31)),
...
static const struct ccu_desc t113_ccu_desc = {
	.gates = t113_gates,
	.resets = t113_resets,
};

static int t113_clk_bind(struct udevice *dev)
{
	return sunxi_reset_bind(dev, ARRAY_SIZE(t113_resets));
}

static const struct udevice_id t113_ccu_ids[] = {
	{ .compatible = "allwinner,sun8i-t113-ccu",
	  .data = (ulong)&t113_ccu_desc },
	{ }
};

U_BOOT_DRIVER(clk_sun8i_t113) = {
	.name		= "sun8i_t113_ccu",
	.id		= UCLASS_CLK,
	.of_match	= t113_ccu_ids,
